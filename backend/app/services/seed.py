...
SERVICE_CATALOG = [
    ...
    (4, 7, "Справка для участия в соревнованиях", "1500.00"),
...
VISIT_TYPES = [
    ...
    ("lmk_new", "Медицинская книжка", "Оформление новой личной медицинской книжки"),
    ("lmk_extend", "Продление медицинской книжки", "Продление личной медицинской книжки"),
